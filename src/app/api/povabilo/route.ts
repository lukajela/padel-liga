          ...
          <div style="max-width:500px;margin:0 auto;background:#051525;border:1px solid #1e3a5f;border-radius:16px;overflow:hidden;">
            ...
            <div style="padding:32px;">
              <p style="color:#93c5fd;font-size:18px;margin:0 0 24px;">
                <strong style="color:white;">${imePovabitelja}</strong> te izziva na padel tekmo v <strong style="color:#60a5fa;text-transform:capitalize;">${liga} Ligi</strong>!
              </p>
              ...
              <a href="http://localhost:3000/iskanje-tekme" 
              ...
              <a href="http://localhost:3000/tekma"
